...
def arg_parse():
    ...
    parser.add_argument("--dataset",dest='dataset',default="GEN1",help="Choose from: GEN1, 1MP_3classes, 1MP_7classes, VISO",type=str,choices=["GEN1", "1MP_3classes", "1MP_7classes", "VISO"])    
    ...
    parser.add_argument("--name", dest = 'name', help = "name of the dataset", default = "VISO", type = str)
